...
class DistrictController extends AbstractController
{
    ...
    public function index(DistrictRepository $districtRepository, RegionRepository $regionRepository): Response
    {
    ...
    public function show(District $district, RegionRepository $regionRepository): Response
    {
